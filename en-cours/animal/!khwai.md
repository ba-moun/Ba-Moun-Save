...
La `Carotid rete mirabile` est un nom `latin`. Il peut se traduire par « filet cérébrale incroyable ». C’est un système d’artères et de veines qui se situe autour de l’hypotalamus du ***!khwai*** (situé dans la tête).
