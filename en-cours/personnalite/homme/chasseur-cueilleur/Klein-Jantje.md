...
flowchart TB
   ...
   euFightInZABegin["1795 : Les Britaniques et les Néerlandais
      commencent à se disputer le sud de l’Afrique"]
   
   euFightInZAEnd["1806 : Les Néerlandais cèdent leur colonie du sud du continent aux Britaniques"]
   ...
   hKOImprisonned["~1869 : |han≠kass’o est emprisonné pour
      vol de bétail avec ||kabbo (son beau-père)
      et Witbooy Touren (son beau-frère)"]
   ...
   subgraph 1877
     huHunWithFriends["Avril 1877 : À Vanwyksvlei, Suobba-||kein et |han≠kass’o
        confient leurs plus grand fils !hu !hun à des amis
        pour qu’ils puissent se rendre chez les Lloyd, au Cap."]
     
     suobbaKeinNBabyDeath["Décembre 1877 : Suobba-||kein succombe à ses blessures
        suite aux coups graves qu’elle a reçue d’un policier.
        Leur bébé n’a pas survécu à l'attaque."]
   end
   
   hKOInformBegin["10 Janvier 1878 : |han≠kass’o arrive à Mowbray seul et commence
      à fournir divers informations sur les Ss’wa ka !kui
      aux familles Lloyd et Bleek"]
...
À sa sortie de prison en `1871`, ***|han≠kass’o*** accompagné de sa femme `Suobba-||kein` vont à Bushmanland. Néanmoins, après la mort de son beau-père `||kabbo` en `1876`, ***|han≠kass’o*** est utilisé comme informateur pour remplacer `||kabbo`. Ainsi, de `Janv.` `1878` à `Déc.` `1879`, ***|han≠kass’o*** fournit des informations linguistiques et historiques à `L.C. Lloyd` et aux `Bleek`.
