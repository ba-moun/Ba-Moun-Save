...
***Wilhelm Sigismund Koelle*** est mort le `18` `février` `1902`. Étant un missionnaire allemand, il a été evoyé en `Sierra Leone`, où il a effectueé le regroupement des langues ouest-africaines, avec `Wilhelm Bleek`.
