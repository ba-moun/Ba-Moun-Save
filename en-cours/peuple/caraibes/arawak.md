...
Ce peuple s'est organisé en région. Par exemple, sur l'île `Haïti`, les ***Taïnos*** ont créé cinq régions régies par un `Kasika` (ou `Kasik`).
Parmi les [^1]
