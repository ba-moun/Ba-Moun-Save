...
* Le `rite Petro` est un héritage ancestral de `Jean-Philippe Don Pedr`. Ce dernier est un initié Kongo dont le nom d'esclave a été `Jean-Philippe Don Pedr`. Ce nom européen est à l'origine du nom du `rite Petro` (Don Pedro → Petro). Le rite est populairement associé au combat et au mysticisme des feuilles.
